...
\begin{document}
	...
	\begin{frame}
		...
		\begin{itemize}
			\item Email: iperez04@manhattan.edu
			\item Office: RLC 204
			\item Office Hours: Wednesday, Friday 10am-11am
			\item \color{blue}{\href{https://lms.manhattan.edu/course/view.php?id=37049
			}{Section 1 Moodle Link}}
			\item \color{blue}{\href{https://lms.manhattan.edu/course/view.php?id=37050
				}{Section 2 Moodle Link}}
		\end{itemize} 
	\end{frame}
	\begin{frame}
